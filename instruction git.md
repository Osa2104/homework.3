...
Чтобы связать наш локальный репозиторий с репозиторием на GitHub, выполним следующую команду в терминале "git remote add origin <ссылка на репозиторий в GitHub>.
...
Команда, предназначенная для этого "git push origin master". 
